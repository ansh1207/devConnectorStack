...
const AddEducation = ({ addEducation, history }) => {
    ...
    return (
        <Fragment>
            ...
            <p class="lead">
                <i class="fas fa-code-branch"></i> Add any school/college you have attended
      </p>
            ...
            <form class="form" onSubmit={e => {
                ...
                <div class="form-group">
                    <input type="text" placeholder="* Degree or Diploma" name="degree" value={degree} onChange={e => onChange(e)} required />
                </div>
                <div class="form-group">
